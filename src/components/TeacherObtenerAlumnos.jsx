...
import { ChevronLeft, ChevronRight, RefreshCw, ChevronsLeft, ChevronsRight, AlertCircle, Loader2, GraduationCap } from 'lucide-react';

const SORT_OPTIONS = [
    { value: 'createdDate', label: 'Fecha de Registro' },
...
export default function TeacherObtenerAlumnos({ onVerDetalles }) {
    ...
    const fetchAlumnos = useCallback(async () => {
        ...
        setError('');
        try {
            const response = await api.get('/teacher', { params: { page, size, sort } });
                                ...
                                <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        {data.content.map((alumno) => {
                                            const badge = STATUS_BADGE[alumno.status] || { label: 'Error de consulta', cls: 'bg-gray-100 text-gray-500' };
                                            return (
